...
OutputState* loadZip3(const char* ipsw, int useMemory) {
    OutputState* toReturn = NULL;
    loadZipFile3(ipsw, &toReturn, NULL, useMemory);
    return toReturn;
}
...
void loadZipFile3(const char* ipsw, OutputState** output, const char* file, int useMemory) {
    char* fileName;
    void* buffer;
    unzFile zip;
    unz_file_info pfile_info;
